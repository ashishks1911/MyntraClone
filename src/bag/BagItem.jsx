    ...
    <div className='w-full flex px-2 py-2.5 border rounded'>
      ...
      <div className='bag-item-right pl-2 text-sm w-[80%]'>
        ...
        <div className='flex gap-2'>
          ...
          {(item.discount_mrp !== 0 || item.discount_percentage !== 0) && <div className='text-[#282c3f] line-through'>&#8377; {item.original_price}</div>}
          {item.discount_mrp !== 0 && <div className='text-[#ff905a]'>&#8377; {item.discount_mrp} OFF</div>}
          {item.discount_percentage !== 0 && <div className='text-[#ff905a]'>{item.discount_percentage}% OFF</div>}
        </div>
