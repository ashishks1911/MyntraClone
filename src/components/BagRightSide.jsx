  ...
  return (
    <div className="bag-right-block border-l p-4">
      ...
      <div>
        ...
        <span className='text-xs px-1 font-bold text-gray-600'>(2 Items)</span>
        <div className='flex justify-between'>
          <div>
            ...
            <div className='text-sm font-normal pt-1'>Platform Fee</div>
            <div className='text-sm font-normal pt-1'>Shipping Fee</div>
          </div>
          <div className='text-right'>
            <div className='text-sm font-normal pt-1'>&#8377;34,760</div>
            <div className='text-sm font-normal pt-1 text-green-500'>- &#8377;27,702</div>
            <div className='text-sm font-normal pt-1'>Apply Coupon</div>
            <div className='text-sm font-normal pt-1'>&#8377;20</div>
            <div className='text-sm font-normal pt-1 text-green-500'>FREE</div>
          </div>
        </div>
        <hr className='mt-2'/>
        <div className='flex justify-between text-md font-bold py-1'>
          <span>Total Amount</span>
          <span className='text-right'>&#8377; 7,076</span>
        </div>
        <div>
