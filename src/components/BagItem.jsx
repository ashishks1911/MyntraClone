    ...
    <div className='w-full flex px-2 py-2.5 border rounded'>
      ...
      <div className='bag-item-right pl-2 text-sm w-[80%]'>
        ...
        <div className='flex gap-2'>
          <div className='text-[#282c3f] font-bold'>Rs. {item.discounted_price}</div>
          <div className='text-[#282c3f] line-through'>Rs. {item.original_price}</div>
          <div className='text-[#ff905a]'>Rs. {item.discount}</div>
        </div>
